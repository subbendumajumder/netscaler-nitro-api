...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/stat/authenticationpolicy
Query-parameters:
args
http://&lt;netscaler-ip-address&gt;/nitro/v1/stat/authenticationpolicy?args=name:&lt;String_value&gt;,detail:&lt;Boolean_value&gt;,fullvalues:&lt;Boolean_value&gt;,ntimes:&lt;Double_value&gt;,logfile:&lt;String_value&gt;,clearstats:&lt;String_value&gt;
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/stat/authenticationpolicy/name_value&gt;&lt;String&gt;
HTTP Method: GET
Request Headers:
