...
URL: http://&lt;NSIP&gt;/nitro/v1/config/rewriteparam
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "rewriteparam": [ {      "undefaction":<String_value>}]}```
