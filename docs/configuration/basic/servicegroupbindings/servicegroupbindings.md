...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings
Query-parameters:
args
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings?args=servicegroupname:&lt;String_value&gt;,
Use this query-parameter to get servicegroupbindings resources based on additional properties.


attrs
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings?attrs=property-name1,property-name2
Use this query parameter to specify the resource details that you want to retrieve.


filter
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings?filter=property-name1:property-val1,property-name2:property-val2
...
view
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings?view=summary
Note: By default, the retrieved results are displayed in detail view (?view=detail).


pagination
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings?pagesize=#no;pageno=#no
...
Response Payload: ```{ "servicegroupbindings": [ {servicegroupname:<String_value>,      "ipaddress":<String_value>,      "port":<Integer_value>,      "state":<String_value>,      "svrstate":<String_value>,      "vservername":<String_value>}]}```
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings/servicegroupname_value&lt;String&gt;
Query-parameters:
attrs
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings/servicegroupname_value&lt;String&gt;?attrs=property-name1,property-name2
Use this query parameter to specify the resource details that you want to retrieve.


view
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings/servicegroupname_value&lt;String&gt;?view=summary
Note: By default, the retrieved results are displayed in detail view (?view=detail).
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/servicegroupbindings?args=servicegroupname:&lt;String_value&gt;,;count=yes
HTTP Method: GET
Request Headers:
