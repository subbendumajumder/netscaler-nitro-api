...
[ADD](#add) | [DELETE](#delete) | [IMPORT](#import) | [GET (ALL)](#get-(all))
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/locationfile
HTTP Method: POST
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/locationfile?action=Import
HTTP Method: POST
Request Headers:
