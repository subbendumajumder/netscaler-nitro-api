...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/responderpolicylabel_binding/labelname_value&lt;String&gt;
HTTP Method: GET
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/responderpolicylabel_binding
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/responderpolicylabel_binding?bulkbindings=yes
