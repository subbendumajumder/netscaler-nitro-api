...
Binding object showing the resources that can be bound to lbmonitor.
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/lbmonitor_binding/monitorname_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "lbmonitor_binding": [ {      "monitorname":<String_value>,      "lbmonitor_metric_binding":<lbmonitor_metric_binding[]_value>,}]}```
