...
URL: http://&lt;NSIP&gt;/nitro/v1/config/nssimpleacl6/aclname_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/nssimpleacl6/aclname_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/nssimpleacl6
Query-parameters:
filter
http://&lt;NSIP&gt;/nitro/v1/config/nssimpleacl6?filter=property-name1:property-val1,property-name2:property-val2
...
view
http://&lt;NS_IP&gt;/nitro/v1/config/nssimpleacl6?view=summary
Use this query-parameter to get the summary output of nssimpleacl6 resources configured on NetScaler.


pagesize=#no;pageno=#no
http://&lt;NS_IP&gt;/nitro/v1/config/nssimpleacl6?pagesize=#no;pageno=#no
Use this query-parameter to get the nssimpleacl6 resources in chunks.


warning
http://&lt;NS_IP&gt;/nitro/v1/config/nssimpleacl6?warning=yes
Use this query parameter to get warnings in nitro response. If this field is set to YES, warning message will be sent in 'message' field and 'WARNING' value is set in severity field of the response in case there is a



HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "nssimpleacl6": [ {      "aclname":<String_value>,      "aclaction":<String_value>,      "td":<Double_value>,      "srcipv6":<String_value>,      "destport":<Integer_value>,      "protocol":<String_value>,      "ttl":<Double_value>,      "hits":<Double_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/nssimpleacl6/aclname_value&lt;String&gt;
HTTP Method: GET
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/nssimpleacl6?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",nssimpleacl6: [ { "__count": "#no"} ] }
