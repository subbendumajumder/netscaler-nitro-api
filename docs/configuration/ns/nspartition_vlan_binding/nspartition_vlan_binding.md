...
HTTP Method: PUT
Request Payload: ```{"params":{      "warning":<String_value>,      "onerror":<String_value>},sessionid":"##sessionid","nspartition_vlan_binding":{      "partitionname":<String_value>,      "vlan":<Double_value>,}}```
Response Payload: 
...
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "nspartition_vlan_binding": [ {      "vlan":<Double_value>,      "partitionname":<String_value>,}]}```
...
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",nspartition_vlan_binding: [ { "__count": "#no"} ] }
