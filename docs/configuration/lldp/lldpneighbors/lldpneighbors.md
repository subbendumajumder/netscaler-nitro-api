...
URL: http://&lt;NSIP&gt;/nitro/v1/config/lldpneighbors
Query-parameters:
filter
http://&lt;NSIP&gt;/nitro/v1/config/lldpneighbors?filter=property-name1:property-val1,property-name2:property-val2
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/lldpneighbors/ifnum_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "lldpneighbors": [ {      "ifnum":<String_value>,      "chassisidsubtype":<String_value>,      "chassisid":<String_value>,      "portidsubtype":<String_value>,      "portid":<String_value>,      "ttl":<Double_value>,      "portdescription":<String_value>,      "sys":<String_value>,      "sysdesc":<String_value>,      "mgmtaddresssubtype":<String_value>,      "mgmtaddress":<String_value>,      "iftype":<String_value>,      "ifnumber":<Double_value>,      "vlan":<String_value>,      "vlanid":<Double_value>,      "portprotosupported":<Double_value>,      "portprotoenabled":<Double_value>,      "portprotoid":<Double_value>,      "portvlanid":<Double_value>,      "protocolid":<String_value>,      "linkaggrcapable":<String_value>,      "linkaggrenabled":<String_value>,      "linkaggrid":<Double_value>,      "flag":<Double_value>,      "syscapabilities":<String_value>,      "syscapenabled":<String_value>,      "autonegsupport":<String_value>,      "autonegenabled":<String_value>,      "autonegadvertised":<String_value>,      "autonegmautype":<String_value>,      "mtu":<Double_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/lldpneighbors?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",lldpneighbors: [ { "__count": "#no"} ] }
