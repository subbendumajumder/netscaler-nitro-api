...
URL: http://NS_IP/nitro/v1/config/vpnglobal_vpnclientlessaccesspolicy_binding
HTTP Method: DELETE
Response Payload: 
...
Query-parameters:
filter
http://&lt;NS_IP&gt;/nitro/v1/config/vpnglobal_vpnclientlessaccesspolicy_binding?filter=property-name1:property-value1,property-name2:property-value2
...
http://&lt;NS_IP&gt;/nitro/v1/config/vpnglobal_vpnclientlessaccesspolicy_binding?pagesize=#no;pageno=#no
Use this query-parameter to get the vpnglobal_vpnclientlessaccesspolicy_binding resources in chunks.



HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "vpnglobal_vpnclientlessaccesspolicy_binding": [ {      "priority":<Double_value>,      "globalbindtype":<String_value>,      "builtin":<String[]_value>,      "policyname":<String_value>,      "secondary":<Boolean_value>,      "type":<String_value>,      "groupextraction":<Boolean_value>,}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/vpnglobal_vpnclientlessaccesspolicy_binding?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",vpnglobal_vpnclientlessaccesspolicy_binding: [ { "__count": "#no"} ] }
