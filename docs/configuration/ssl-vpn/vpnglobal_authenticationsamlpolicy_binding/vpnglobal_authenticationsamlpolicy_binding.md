...
<b>URL:</b>http://&lt;netscaler-ip-address/nitro/v1/config/vpnglobal_authenticationsamlpolicy_binding
<b>HTTP Method:</b>PUT
<b>Request Headers:</b>
...
<b>filter</b>
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/vpnglobal_authenticationsamlpolicy_binding?<b>filter=property-name1:property-value1,property-name2:property-value2</b>
Use this query-parameter to get the filtered set of vpnglobal_authenticationsamlpolicy_binding resources configured on NetScaler.Filtering can be done on any of the properties of the resource.


<b>pagination</b>
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/vpnglobal_authenticationsamlpolicy_binding?<b>pagesize=#no;pageno=#no</b>
Use this query-parameter to get the vpnglobal_authenticationsamlpolicy_binding resources in chunks.
...
<b>Query-parameters:</b>
<b>bulkbindings</b>
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/vpnglobal_authenticationsamlpolicy_binding?<b>bulkbindings=yes</b>
...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/vpnglobal_authenticationsamlpolicy_binding?<b>count=yes</b>
<b>HTTP Method:</b>GET
<b>Request Headers:</b>
...
<b>Response Payload: </b>```{ "vpnglobal_authenticationsamlpolicy_binding": [ { "__count": "#no"} ] }```
