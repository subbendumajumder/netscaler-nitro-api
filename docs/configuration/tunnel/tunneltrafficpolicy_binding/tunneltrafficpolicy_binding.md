...
Binding object showing the resources that can be bound to tunneltrafficpolicy.
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/tunneltrafficpolicy_binding/name_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "tunneltrafficpolicy_binding": [ {      "name":<String_value>,      "tunneltrafficpolicy_tunnelglobal_binding":<tunneltrafficpolicy_tunnelglobal_binding[]_value>,}]}```
