...
HTTP Method: PUT
Request Payload: ```{"params":{      "warning":<String_value>,      "onerror":<String_value>},sessionid":"##sessionid","lsngroup_lsnpool_binding":{      "groupname":<String_value>,      "poolname":<String_value>,}}```
Response Payload: 
...
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "lsngroup_lsnpool_binding": [ {      "poolname":<String_value>,      "groupname":<String_value>,}]}```
...
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",lsngroup_lsnpool_binding: [ { "__count": "#no"} ] }
