...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsnappsprofile_binding/appsprofilename_value&lt;String&gt;
HTTP Method: GET
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsnappsprofile_binding
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsnappsprofile_binding?bulkbindings=yes
