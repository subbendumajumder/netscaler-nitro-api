...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsnpool_binding/poolname_value&lt;String&gt;
HTTP Method: GET
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsnpool_binding
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsnpool_binding?bulkbindings=yes
