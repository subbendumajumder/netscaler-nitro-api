...
<b>URL:</b>http://&lt;netscaler-ip-address/nitro/v1/config/lsngroup_ipsecalgprofile_binding
<b>HTTP Method:</b>PUT
<b>Request Headers:</b>

Cookie:NITRO_AUTH_TOKEN=&lt;tokenvalue&gt;Content-Type:application/json

<b>Request Payload: </b>```{"lsngroup_ipsecalgprofile_binding":{<b>"groupname":<String_value>,</b>"ipsecalgprofile":<String_value>}}```
<b>Response:</b>
...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsngroup_ipsecalgprofile_binding/groupname_value&lt;String&gt;
...
<b>filter</b>
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsngroup_ipsecalgprofile_binding/groupname_value&lt;String&gt;?<b>filter=property-name1:property-value1,property-name2:property-value2</b>
...
<b>pagination</b>
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsngroup_ipsecalgprofile_binding/groupname_value&lt;String&gt;?<b>pagesize=#no;pageno=#no</b>
...
<b>Query-parameters:</b>
<b>bulkbindings</b>
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsngroup_ipsecalgprofile_binding?<b>bulkbindings=yes</b>
...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/lsngroup_ipsecalgprofile_binding/groupname_value&lt;String&gt;?<b>count=yes</b>
<b>HTTP Method:</b>GET
<b>Request Headers:</b>
...
<b>Response Payload: </b>```{"lsngroup_ipsecalgprofile_binding": [ { "__count": "#no"} ] }```
