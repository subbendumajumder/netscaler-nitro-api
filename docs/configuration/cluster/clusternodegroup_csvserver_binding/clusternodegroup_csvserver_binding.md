...
HTTP Method: PUT
Request Payload: ```{"params":{      "warning":<String_value>,      "onerror":<String_value>},sessionid":"##sessionid","clusternodegroup_csvserver_binding":{      "name":<String_value>,      "vserver":<String_value>,}}```
Response Payload: 
...
URL: http://NS_IP/nitro/v1/config/clusternodegroup_csvserver_binding
HTTP Method: DELETE
Response Payload: 
...
Query-parameters:
filter
http://&lt;NS_IP&gt;/nitro/v1/config/clusternodegroup_csvserver_binding?filter=property-name1:property-value1,property-name2:property-value2
...
http://&lt;NS_IP&gt;/nitro/v1/config/clusternodegroup_csvserver_binding?pagesize=#no;pageno=#no
Use this query-parameter to get the clusternodegroup_csvserver_binding resources in chunks.



HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "clusternodegroup_csvserver_binding": [ {      "vserver":<String_value>,      "name":<String_value>,}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/clusternodegroup_csvserver_binding?args=;count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",clusternodegroup_csvserver_binding: [ { "__count": "#no"} ] }
