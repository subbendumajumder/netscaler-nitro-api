...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/auditnslogparams
HTTP Method: PUT
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/auditnslogparams?action=unset
HTTP Method: POST
Request Headers:
