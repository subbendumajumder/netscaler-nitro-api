...
URL: http://&lt;NSIP&gt;/nitro/v1/config/appfwwsdl/name_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/appfwwsdl/name_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/appfwwsdl
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "appfwwsdl": [ {      "name":<String_value>,      "response":<String_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/appfwwsdl/name_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "appfwwsdl": [ {      "name":<String_value>,      "response":<String_value>}]}```
