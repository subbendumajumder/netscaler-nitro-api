...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/appfwpolicy_appfwpolicylabel_binding/name_value&lt;String&gt;
<b>Query-parameters:</b>
<b>filter</b>
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/appfwpolicy_appfwpolicylabel_binding/name_value&lt;String&gt;?<b>filter=property-name1:property-value1,property-name2:property-value2</b>
Use this query-parameter to get the filtered set of appfwpolicy_appfwpolicylabel_binding resources configured on NetScaler.Filtering can be done on any of the properties of the resource.


<b>pagination</b>
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/appfwpolicy_appfwpolicylabel_binding/name_value&lt;String&gt;?<b>pagesize=#no;pageno=#no</b>
Use this query-parameter to get the appfwpolicy_appfwpolicylabel_binding resources in chunks.
...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/appfwpolicy_appfwpolicylabel_binding
<b>Query-parameters:</b>
<b>bulkbindings</b>
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/appfwpolicy_appfwpolicylabel_binding?<b>bulkbindings=yes</b>
...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/appfwpolicy_appfwpolicylabel_binding/name_value&lt;String&gt;?<b>count=yes</b>
<b>HTTP Method:</b>GET
<b>Request Headers:</b>
...
<b>Response Payload: </b>```{"appfwpolicy_appfwpolicylabel_binding": [ { "__count": "#no"} ] }```
