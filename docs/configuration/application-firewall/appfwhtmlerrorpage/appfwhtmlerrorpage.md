...
URL: http://&lt;NSIP&gt;/nitro/v1/config/appfwhtmlerrorpage/name_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/appfwhtmlerrorpage/name_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/appfwhtmlerrorpage
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "appfwhtmlerrorpage": [ {      "name":<String_value>,      "response":<String_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/appfwhtmlerrorpage/name_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "appfwhtmlerrorpage": [ {      "name":<String_value>,      "response":<String_value>}]}```
