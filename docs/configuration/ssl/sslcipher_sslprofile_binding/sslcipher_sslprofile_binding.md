...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/sslcipher_sslprofile_binding
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/sslcipher_sslprofile_binding?bulkbindings=yes
