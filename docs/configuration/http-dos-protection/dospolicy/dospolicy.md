...
URL: http://&lt;NSIP&gt;/nitro/v1/config/dospolicy/name_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/dospolicy/name_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/dospolicy
Query-parameters:
filter
http://&lt;NSIP&gt;/nitro/v1/config/dospolicy?filter=property-name1:property-val1,property-name2:property-val2
...
view
http://&lt;NS_IP&gt;/nitro/v1/config/dospolicy?view=summary
Use this query-parameter to get the summary output of dospolicy resources configured on NetScaler.


pagesize=#no;pageno=#no
http://&lt;NS_IP&gt;/nitro/v1/config/dospolicy?pagesize=#no;pageno=#no
Use this query-parameter to get the dospolicy resources in chunks.


warning
http://&lt;NS_IP&gt;/nitro/v1/config/dospolicy?warning=yes
Use this query parameter to get warnings in nitro response. If this field is set to YES, warning message will be sent in 'message' field and 'WARNING' value is set in severity field of the response in case there is a



HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "dospolicy": [ {      "name":<String_value>,      "qdepth":<Double_value>,      "cltdetectrate":<Double_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/dospolicy/name_value&lt;String&gt;
HTTP Method: GET
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/dospolicy?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",dospolicy: [ { "__count": "#no"} ] }
