...
URL: http://&lt;NSIP&gt;/nitro/v1/config/dnstxtrec/domain_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/dnstxtrec/domain_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/dnstxtrec
Query-parameters:
args
http://&lt;NSIP&gt;/nitro/v1/config/dnstxtrec?args=      "domain":&lt;String_value&gt;,      "type":&lt;String_value&gt;,
Use this query-parameter to get dnstxtrec resources based on additional properties.


filter
http://&lt;NSIP&gt;/nitro/v1/config/dnstxtrec?filter=property-name1:property-val1,property-name2:property-val2
...
view
http://&lt;NS_IP&gt;/nitro/v1/config/dnstxtrec?view=summary
Use this query-parameter to get the summary output of dnstxtrec resources configured on NetScaler.


pagesize=#no;pageno=#no
http://&lt;NS_IP&gt;/nitro/v1/config/dnstxtrec?pagesize=#no;pageno=#no
Use this query-parameter to get the dnstxtrec resources in chunks.


warning
http://&lt;NS_IP&gt;/nitro/v1/config/dnstxtrec?warning=yes
Use this query parameter to get warnings in nitro response. If this field is set to YES, warning message will be sent in 'message' field and 'WARNING' value is set in severity field of the response in case there is a



HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "dnstxtrec": [ {      "domain":<String_value>,      "type":<String_value>,      "String":<String[]_value>,      "ttl":<Double_value>,      "recordid":<Double_value>,      "authtype":<String_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/dnstxtrec/domain_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "dnstxtrec": [ {      "domain":<String_value>,      "type":<String_value>,      "String":<String[]_value>,      "ttl":<Double_value>,      "recordid":<Double_value>,      "authtype":<String_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/dnstxtrec?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",dnstxtrec: [ { "__count": "#no"} ] }
