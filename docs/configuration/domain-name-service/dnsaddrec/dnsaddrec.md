...
URL: http://&lt;NSIP&gt;/nitro/v1/config/dnsaddrec/hostname_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/dnsaddrec/hostname_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/dnsaddrec
Query-parameters:
args
http://&lt;NSIP&gt;/nitro/v1/config/dnsaddrec?args=      "hostname":&lt;String_value&gt;,      "type":&lt;String_value&gt;,
Use this query-parameter to get dnsaddrec resources based on additional properties.


filter
http://&lt;NSIP&gt;/nitro/v1/config/dnsaddrec?filter=property-name1:property-val1,property-name2:property-val2
...
view
http://&lt;NS_IP&gt;/nitro/v1/config/dnsaddrec?view=summary
Use this query-parameter to get the summary output of dnsaddrec resources configured on NetScaler.


pagesize=#no;pageno=#no
http://&lt;NS_IP&gt;/nitro/v1/config/dnsaddrec?pagesize=#no;pageno=#no
Use this query-parameter to get the dnsaddrec resources in chunks.


warning
http://&lt;NS_IP&gt;/nitro/v1/config/dnsaddrec?warning=yes
Use this query parameter to get warnings in nitro response. If this field is set to YES, warning message will be sent in 'message' field and 'WARNING' value is set in severity field of the response in case there is a



HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "dnsaddrec": [ {      "hostname":<String_value>,      "type":<String_value>,      "ipaddress":<String_value>,      "ttl":<Double_value>,      "vservername":<String_value>,      "authtype":<String_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/dnsaddrec/hostname_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "dnsaddrec": [ {      "hostname":<String_value>,      "type":<String_value>,      "ipaddress":<String_value>,      "ttl":<Double_value>,      "vservername":<String_value>,      "authtype":<String_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/dnsaddrec?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",dnsaddrec: [ { "__count": "#no"} ] }
