...
Query-parameters:
filter
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/authenticationvserver_vpnportaltheme_binding/name_value&lt;String&gt;?filter=property-name1:property-value1,property-name2:property-value2
...
pagination
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/authenticationvserver_vpnportaltheme_binding/name_value&lt;String&gt;?pagesize=#no;pageno=#no
...
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/authenticationvserver_vpnportaltheme_binding?bulkbindings=yes
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/authenticationvserver_vpnportaltheme_binding/name_value&lt;String&gt;?count=yes
HTTP Method: GET
Request Headers:
