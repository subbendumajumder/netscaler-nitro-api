...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/authenticationsamlidppolicy_binding/name_value&lt;String&gt;
HTTP Method: GET
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/authenticationsamlidppolicy_binding
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/authenticationsamlidppolicy_binding?bulkbindings=yes
