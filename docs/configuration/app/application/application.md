...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/application?<b>action=Import</b>
<b>HTTP Method:</b>POST
<b>Request Headers:</b>

Cookie:NITRO_AUTH_TOKEN=&lt;tokenvalue&gt;Content-Type:application/json

<b>Request Payload: </b>```{"application":{<b>"apptemplatefilename":<String_value>,</b>"appname":<String_value>,"deploymentfilename":<String_value>}}```
<b>Response:</b>
...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/application?<b>action=export</b>
<b>HTTP Method:</b>POST
<b>Request Headers:</b>
...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/application
