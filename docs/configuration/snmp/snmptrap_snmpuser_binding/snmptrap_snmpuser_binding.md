...
URL: http://&lt;netscaler-ip-address/nitro/v1/config/snmptrap_snmpuser_binding
HTTP Method: PUT
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/snmptrap_snmpuser_binding/trapclass_value&lt;String&gt;
HTTP Method: DELETE
Request Headers:
...
Query-parameters:
args
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/snmptrap_snmpuser_binding?args=trapdestination:&lt;String_value&gt;,version:&lt;String_value&gt;,td:&lt;Double_value&gt;,trapclass:&lt;String_value&gt;
Use this query-parameter to get snmptrap_snmpuser_binding resources based on additional properties.


filter
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/snmptrap_snmpuser_binding?filter=property-name1:property-value1,property-name2:property-value2
...
pagination
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/snmptrap_snmpuser_binding?pagesize=#no;pageno=#no
...
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/snmptrap_snmpuser_binding?bulkbindings=yes
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/snmptrap_snmpuser_binding?args=trapdestination:&lt;String_value&gt;,version:&lt;String_value&gt;,td:&lt;Double_value&gt;,trapclass:&lt;String_value&gt;;count=yes
HTTP Method: GET
Request Headers:
