...
URL: http://&lt;netscaler-ip-address/nitro/v1/config/hanode_routemonitor6_binding
HTTP Method: PUT
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/hanode_routemonitor6_binding/id_value&lt;Double&gt;
HTTP Method: DELETE
Request Headers:
...
Query-parameters:
filter
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/hanode_routemonitor6_binding/id_value&lt;Double&gt;?filter=property-name1:property-value1,property-name2:property-value2
...
pagination
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/hanode_routemonitor6_binding/id_value&lt;Double&gt;?pagesize=#no;pageno=#no
...
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/hanode_routemonitor6_binding?bulkbindings=yes
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/hanode_routemonitor6_binding/id_value&lt;Double&gt;?count=yes
HTTP Method: GET
Request Headers:
