...
URL: http://&lt;NSIP&gt;/nitro/v1/config/tmtrafficaction/name_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/tmtrafficaction/name_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/tmtrafficaction
Query-parameters:
filter
http://&lt;NSIP&gt;/nitro/v1/config/tmtrafficaction?filter=property-name1:property-val1,property-name2:property-val2
...
view
http://&lt;NS_IP&gt;/nitro/v1/config/tmtrafficaction?view=summary
Use this query-parameter to get the summary output of tmtrafficaction resources configured on NetScaler.


pagesize=#no;pageno=#no
http://&lt;NS_IP&gt;/nitro/v1/config/tmtrafficaction?pagesize=#no;pageno=#no
Use this query-parameter to get the tmtrafficaction resources in chunks.


warning
http://&lt;NS_IP&gt;/nitro/v1/config/tmtrafficaction?warning=yes
Use this query parameter to get warnings in nitro response. If this field is set to YES, warning message will be sent in 'message' field and 'WARNING' value is set in severity field of the response in case there is a



HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "tmtrafficaction": [ {      "name":<String_value>,      "apptimeout":<Double_value>,      "sso":<String_value>,      "formssoaction":<String_value>,      "persistentcookie":<String_value>,      "initiatelogout":<String_value>,      "kcdaccount":<String_value>,      "samlssoprofile":<String_value>,      "forcedtimeout":<String_value>,      "forcedtimeoutval":<Double_value>,      "userexpression":<String_value>,      "passwdexpression":<String_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/tmtrafficaction/name_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "tmtrafficaction": [ {      "name":<String_value>,      "apptimeout":<Double_value>,      "sso":<String_value>,      "formssoaction":<String_value>,      "persistentcookie":<String_value>,      "initiatelogout":<String_value>,      "kcdaccount":<String_value>,      "samlssoprofile":<String_value>,      "forcedtimeout":<String_value>,      "forcedtimeoutval":<Double_value>,      "userexpression":<String_value>,      "passwdexpression":<String_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/tmtrafficaction?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",tmtrafficaction: [ { "__count": "#no"} ] }
