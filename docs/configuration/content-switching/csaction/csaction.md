...
URL: http://&lt;NSIP&gt;/nitro/v1/config/csaction/name_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/csaction/name_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/csaction
Query-parameters:
filter
http://&lt;NSIP&gt;/nitro/v1/config/csaction?filter=property-name1:property-val1,property-name2:property-val2
...
view
http://&lt;NS_IP&gt;/nitro/v1/config/csaction?view=summary
Use this query-parameter to get the summary output of csaction resources configured on NetScaler.


pagesize=#no;pageno=#no
http://&lt;NS_IP&gt;/nitro/v1/config/csaction?pagesize=#no;pageno=#no
Use this query-parameter to get the csaction resources in chunks.


warning
http://&lt;NS_IP&gt;/nitro/v1/config/csaction?warning=yes
Use this query parameter to get warnings in nitro response. If this field is set to YES, warning message will be sent in 'message' field and 'WARNING' value is set in severity field of the response in case there is a
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/csaction?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",csaction: [ { "__count": "#no"} ] }
