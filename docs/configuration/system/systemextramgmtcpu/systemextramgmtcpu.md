...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/systemextramgmtcpu?action=enable
HTTP Method: POST
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/systemextramgmtcpu?action=disable
HTTP Method: POST
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/systemextramgmtcpu
HTTP Method: GET
Request Headers:
