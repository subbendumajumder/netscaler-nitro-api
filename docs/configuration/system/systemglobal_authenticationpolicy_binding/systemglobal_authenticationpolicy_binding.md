...
URL: http://&lt;netscaler-ip-address/nitro/v1/config/systemglobal_authenticationpolicy_binding
HTTP Method: PUT
Request Headers:
...
Query-parameters:
filter
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/systemglobal_authenticationpolicy_binding?filter=property-name1:property-value1,property-name2:property-value2
...
pagination
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/systemglobal_authenticationpolicy_binding?pagesize=#no;pageno=#no
...
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/systemglobal_authenticationpolicy_binding?bulkbindings=yes
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/systemglobal_authenticationpolicy_binding?count=yes
HTTP Method: GET
Request Headers:
