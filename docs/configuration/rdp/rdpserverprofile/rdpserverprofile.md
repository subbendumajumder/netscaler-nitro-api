...
URL: http://&lt;NSIP&gt;/nitro/v1/config/rdpserverprofile/name_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/rdpserverprofile/name_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/rdpserverprofile
Query-parameters:
filter
http://&lt;NSIP&gt;/nitro/v1/config/rdpserverprofile?filter=property-name1:property-val1,property-name2:property-val2
...
view
http://&lt;NS_IP&gt;/nitro/v1/config/rdpserverprofile?view=summary
Use this query-parameter to get the summary output of rdpserverprofile resources configured on NetScaler.


pagesize=#no;pageno=#no
http://&lt;NS_IP&gt;/nitro/v1/config/rdpserverprofile?pagesize=#no;pageno=#no
Use this query-parameter to get the rdpserverprofile resources in chunks.


warning
http://&lt;NS_IP&gt;/nitro/v1/config/rdpserverprofile?warning=yes
Use this query parameter to get warnings in nitro response. If this field is set to YES, warning message will be sent in 'message' field and 'WARNING' value is set in severity field of the response in case there is a



HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "severity": <String_value>, "rdpserverprofile": [ {      "name":<String_value>,      "rdpip":<String_value>,      "rdpport":<Double_value>,      "psk":<String_value>,      "builtin":<String[]_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/rdpserverprofile/name_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "rdpserverprofile": [ {      "name":<String_value>,      "rdpip":<String_value>,      "rdpport":<Double_value>,      "psk":<String_value>,      "builtin":<String[]_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/rdpserverprofile?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",rdpserverprofile: [ { "__count": "#no"} ] }
