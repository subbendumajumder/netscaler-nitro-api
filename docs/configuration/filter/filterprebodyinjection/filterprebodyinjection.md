...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/filterprebodyinjection
<b>HTTP Method:</b>PUT
<b>Request Headers:</b>

Cookie:NITRO_AUTH_TOKEN=&lt;tokenvalue&gt;Content-Type:application/json

<b>Request Payload: </b>```{"filterprebodyinjection":{<b>"prebody":<String_value></b>}}```
<b>Response:</b>
...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/filterprebodyinjection?<b>action=unset</b>
