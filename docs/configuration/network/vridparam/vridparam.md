...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/vridparam
<b>HTTP Method:</b>PUT
<b>Request Headers:</b>
...
<b>URL:</b>http://&lt;netscaler-ip-address&gt;/nitro/v1/config/vridparam?<b>action=unset</b>
