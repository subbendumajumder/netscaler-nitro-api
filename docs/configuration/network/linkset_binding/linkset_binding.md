...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/linkset_binding/id_value&lt;String&gt;
HTTP Method: GET
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/linkset_binding
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/linkset_binding?bulkbindings=yes
