...
Binding object showing the resources that can be bound to nd6ravariables.
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/nd6ravariables_binding/vlan_value&lt;Double&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "nd6ravariables_binding": [ {      "vlan":<Double_value>,      "nd6ravariables_onlinkipv6prefix_binding":<nd6ravariables_onlinkipv6prefix_binding[]_value>,}]}```
