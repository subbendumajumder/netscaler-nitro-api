...
HTTP Method: PUT
Request Payload: ```{"params":{      "warning":<String_value>,      "onerror":<String_value>},sessionid":"##sessionid","fis_interface_binding":{      "name":<String_value>,      "ifnum":<String_value>,}}```
Response Payload: 
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/fis_interface_binding/name_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/fis_interface_binding/name_value&lt;String&gt;?warning=yes
