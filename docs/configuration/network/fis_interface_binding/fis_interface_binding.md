...
URL: http://&lt;netscaler-ip-address/nitro/v1/config/fis_interface_binding
HTTP Method: PUT
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/fis_interface_binding/name_value&lt;String&gt;
HTTP Method: DELETE
Request Headers:
