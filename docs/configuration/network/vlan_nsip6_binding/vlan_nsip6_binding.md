...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/vlan_nsip6_binding/id_value&lt;Double&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/vlan_nsip6_binding/id_value&lt;Double&gt;?warning=yes
...
Query-parameters:
filter
http://&lt;NS_IP&gt;/nitro/v1/config/vlan_nsip6_binding/id_value&lt;Double&gt;?filter=property-name1:property-value1,property-name2:property-value2
...
http://&lt;NS_IP&gt;/nitro/v1/config/vlan_nsip6_binding/id_value&lt;Double&gt;?pagesize=#no;pageno=#no
Use this query-parameter to get the vlan_nsip6_binding resources in chunks.


warning
http://&lt;NS_IP&gt;/nitro/v1/config/vlan_nsip6_binding?warning=yes
Use this query parameter to get warnings in nitro response. If this field is set to YES, warning message will be sent in 'message' field and 'WARNING' value is set in severity field of the response in case there is a
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/vlan_nsip6_binding/id_value&lt;Double&gt;?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",vlan_nsip6_binding: [ { "__count": "#no"} ] }
