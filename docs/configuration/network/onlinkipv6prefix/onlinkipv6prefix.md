...
URL: http://&lt;NSIP&gt;/nitro/v1/config/onlinkipv6prefix/ipv6prefix_value&lt;String&gt;
Query-parameters:
warning
http://&lt;NS_IP&gt;/nitro/v1/config/onlinkipv6prefix/ipv6prefix_value&lt;String&gt;?warning=yes
...
URL: http://&lt;NSIP&gt;/nitro/v1/config/onlinkipv6prefix
Query-parameters:
filter
http://&lt;NSIP&gt;/nitro/v1/config/onlinkipv6prefix?filter=property-name1:property-val1,property-name2:property-val2
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/onlinkipv6prefix/ipv6prefix_value&lt;String&gt;
HTTP Method: GET
Response Payload: ```{ "errorcode": 0, "message": "Done", "onlinkipv6prefix": [ {      "ipv6prefix":<String_value>,      "onlinkprefix":<String_value>,      "autonomusprefix":<String_value>,      "depricateprefix":<String_value>,      "decrementprefixlifetimes":<String_value>,      "prefixvalidelifetime":<Double_value>,      "prefixpreferredlifetime":<Double_value>,      "prefixcurrvalidelft":<Double_value>,      "prefixcurrpreferredlft":<Double_value>}]}```
...
URL: http://&lt;NS_IP&gt;/nitro/v1/config/onlinkipv6prefix?count=yes
HTTP Method: GET
Response Payload: 
{ "errorcode": 0, "message": "Done",onlinkipv6prefix: [ { "__count": "#no"} ] }
