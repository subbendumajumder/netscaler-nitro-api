...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/rnat6_binding/name_value&lt;String&gt;
HTTP Method: GET
Request Headers:
...
URL: http://&lt;netscaler-ip-address&gt;/nitro/v1/config/rnat6_binding
Query-parameters:
bulkbindings
http://&lt;netscaler-ip-address&gt;/nitro/v1/config/rnat6_binding?bulkbindings=yes
